function createDiv()
{
	...
	leftDiv.className = 'lDiv';
	leftDiv.id = 'theLeftDiv';
	leftDiv.setAttribute('title', 'Left Div');

	rightDiv.className = 'rDiv';
	rightDiv.id = 'theRightDiv';
	rightDiv.setAttribute('title', 'Right Div');
	...
	// Append Select Box to Div, Div to Body
...
var goldfish = new Animal("Goldfish (Carassius auratus)", "The goldfish is a freshwater fish in the family Cyprinidae of order Cypriniformes. It is one of the most commonly kept aquarium fish. A relatively small member of the carp family, the goldfish is native to East Asia.");
